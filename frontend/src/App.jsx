          ...
          {activeMicroservice && (
            <div className="p-8">
              ...
              <CSVSection
                ...
                csvFormat={{
                  etudiants: 'code, nom, prenom, email, telephone, date_naissance, adresse, program_id, level_id, group_id, annee_admission, statut',
                  enseignants: 'code, nom, prenom, email, telephone, specialite, grade, department_id, date_embauche, statut, bureau',
